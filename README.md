...
* **`parte-1-post-clase/`** → Contiene los ejercicios recomendados para realizar fuera de clase (del Ejercicio 3 al 40).
* **`parte-2-portafolio/`** → Contiene los problemas tipo Portafolio (del Problema 1 al 22).
* **`capturas/`** → Carpeta con las imágenes de los códigos y sus respectivas ejecuciones, cumpliendo con el requisito obligatorio de validación.
